...
import { 
  ...
  ArrowLeft, Send, ShieldAlert, WhatsappIcon, MessageCircle 
} from 'lucide-react';
...
const GenerateDetailedReport = () => {
  ...
  const generatePDF = () => {
    try {
      ...
      // Add logo
      const logoUrl = "https://www.reportify.app/logo.png"; // Replace with your actual logo URL
      // doc.addImage(logoUrl, 'PNG', 10, 10, 50, 20); // Mock logo
      
      // Add header
      doc.setFontSize(22);
      doc.setTextColor(0, 51, 102); // Shield blue color
